...
def main():
    ...
    try:
        attack_commands = file("sqli_time_query").read()
        attack_commands = attack_commands.split("\n")
        
    except:
        print "[+] there is no sqli_time_query file"
        connection.close()
        sys.exit(0)
...
# case 2, 3
    ...
    print "*" * 120
    print '\nsql injection(time) attack is done: ', end_time - start_time
    print "*" * 120
    connection.close()
