...
def sql_injection_attack(payloads, method, action, case):
    ...
    for url in urls:
        ...
        if urlparse(url)[4]:
            ...
            if url_with_params not in links_to_visit_params:
                ...
                sql_injection_attack(payloads, "GET", url, "case1")
            ...
            for result in results:
                ...
                if method == "GET":
                    ...
                    if url_with_params not in links_to_visit_params:
                        ...
                        sql_injection_attack(payloads, "GET", action, "case2")
                    ...
                    if url_with_params not in links_to_visit_params:
                        ...
                        sql_injection_attack(payloads, "POST", action, "case3")
               
                        links_to_visit_params.append(url_with_params) 


def predict_sql_injection_attack_time():
...
def main():
    ...
    usage        = '''./sql_injection_error_based.py -t google'''
    ...
    try:
        attack_commands = file("sqli_error_query").read()
        attack_commands = attack_commands.split("\n")
        
    except:
        print "[+] there is no sqli_error_query file"
        connection.close()
        sys.exit(0)
    ...
    predict_sql_injection_attack_time()
...
# case 2, 3
    ...
    print "*" * 120
    print '\nsql injection(error) attack is done: ', end_time - start_time
    print "*" * 120
    connection.close()
