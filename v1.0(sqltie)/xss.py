        ...
        try:
            ...
            if cookie is None:
                ...
                try:
                    ...
                    print '\nxss attack\'s stage 2 is suddenly done: ', end_time - start_time
                    print "*" * 120
...
#step1
    ...
    print '\nxss attack\'s stage 1 is done: ', end_time - start_time
    print "*" * 120
...
#         if there is no form, it return False 
            ...
            for result in results:
                ...
                if method == "GET":
                    ...
                    if url_with_params not in links_to_visit_params:
                        ...
                        xss_attack(payloads, method, action, "case2", attack_commands)
    ...
    print "*" * 120
    print "you send requests %s times" % (req_cnt - f_req_cnt)
    print '\nxss attack\'s stage 2 is done: ', end_time - start_time
    print "*" * 120
